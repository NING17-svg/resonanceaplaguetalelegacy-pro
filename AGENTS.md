...
`resonanceaplaguetalelegacy.pro` is the live guide hub for Resonance: A Plague Tale Legacy (Asobo Studio / Focus Entertainment). After launch, treat this project as a live content property, not as the central workflow repo or a template.
